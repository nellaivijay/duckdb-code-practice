# Contributing to DuckDB Code Practice

Thank you for your interest in contributing to this educational repository! This project is designed to help data engineers, analysts, and developers practice and improve their DuckDB skills through hands-on coding labs and exercises.

## Educational Purpose

This repository is an independent educational resource created to help data professionals:
- Practice DuckDB and modern analytics concepts
- Learn vendor-independent data analytics patterns
- Understand modern SQL database design and columnar storage
- Build hands-on experience with Python, SQL, and data processing
- Prepare for real-world data analytics challenges

## How to Contribute

### Adding New Labs

1. **Choose a topic**: Pick a new area of DuckDB or analytics technology
...
6. Test thoroughly in both Python and Docker environments
...
1. Test the lab in both Python and Docker setups
...
- Test scripts in both Python and Docker environments
...
- Linking to official DuckDB documentation
...
- Verify package dependencies are reasonable
- Check virtual environment setup
- Test script execution and error handling
- Verify data file generation and loading
